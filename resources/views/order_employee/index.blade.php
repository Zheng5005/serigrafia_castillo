                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                        ...
                                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                            ...
                                            <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    <a href="{{ route('order_employee.show', $rs->id)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Detalles</a>
                                                    <a href="{{ route('order_employee.edit', $rs->id)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Editar</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
                                @else
                                    <tr>
                                        <td class="text-center" colspan="5">Ordenes no encontradas</td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
